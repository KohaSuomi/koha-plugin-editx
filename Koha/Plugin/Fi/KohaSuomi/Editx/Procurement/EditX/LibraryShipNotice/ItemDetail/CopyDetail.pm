#!/usr/bin/perl
package Koha::Plugin::Fi::KohaSuomi::Editx::Procurement::EditX::LibraryShipNotice::ItemDetail::CopyDetail;
...
has 'branchLocationYear' => (
    is => 'rw',
    isa => 'Koha::Plugin::Fi::KohaSuomi::Editx::Procurement::BranchLocationYear::Parser',
...
has 'marcHelper' => (
    ...
    isa => 'Koha::Plugin::Fi::KohaSuomi::Editx::Procurement::EditX::LibraryShipNotice::MarcHelper'
);
...
sub BUILD {
    my $self = shift;
    my $marcH = Koha::Plugin::Fi::KohaSuomi::Editx::Procurement::EditX::LibraryShipNotice::MarcHelper->new;
    $self->setMarcHelper($marcH);
    $self->setBranchExtractor(Koha::Plugin::Fi::KohaSuomi::Editx::Procurement::BranchLocationYear::Parser->new());
}
...
sub getStandardIdentifierIndicator {
    my $self = shift;
    my $marcRecord = $self->getMarcData();
    my $result;
